                        ...
                        <v-card class="pa-5 mt-3 border-sm">
                            <v-card-title>
                                <v-col class="d-flex align-center pa-4">
                                    ...
                                    <span class="font-weight-bold text-h6 ml-2">Detail Tracking</span>
                                </v-col>
                            </v-card-title>
                            <v-card class='border-md'>
                                <v-table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ trackingData.kodeTransaksi }}</td>
                                        </tr>
                                        <tr>
                                            <td>Posisi Flow</td>
                                            <td>{{ trackingData.posisiFlow }}</td>
                                        </tr>
                                        <tr>
                                            <td>Keterangan</td>
                                            <td>{{ trackingData.keterangan }}</td>
                                        </tr>
                                        <tr>
                                            <td>Nama Scenario</td>
                                            <td>{{ trackingData.namaScenario }}</td>
                                        </tr>
                                        <tr>
                                            <td>User Drafter</td>
                                            <td>{{ trackingData.userDrafter }}</td>
                                        </tr>
                                        <tr>
                                            <td>Update Terakhir</td>
                                            <td>{{ trackingData.updateTerakhir }}</td>
                                        </tr>
                                        <tr>
                                            <td>Tracking Flow</td>
                                            <td><v-btn color="primary" @click="lihatDetail">Lihat</v-btn></td>
                                        </tr>
                                    </tbody>
                                </v-table>
                            </v-card>
